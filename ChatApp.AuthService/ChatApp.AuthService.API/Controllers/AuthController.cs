...
using ChatApp.AuthService.Core.Interfaces;
using ChatApp.AuthService.Core.Constants;
using ChatApp.AuthService.Core.DTOs;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Shared.Enums.User;

namespace ChatApp.AuthService.API.Controllers
{
    [ApiController]
